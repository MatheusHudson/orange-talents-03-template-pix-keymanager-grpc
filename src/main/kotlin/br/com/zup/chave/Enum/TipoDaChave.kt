...
enum class TipoDaChave {
    ...
    CPF {
        override fun valida(chaveValor: String, createResponse: () -> Unit, createResponseError: (String) -> Unit) {
    ...
    abstract fun valida(chaveValor: String, createResponse: () -> Unit, createResponseError: (String) -> Unit)
}